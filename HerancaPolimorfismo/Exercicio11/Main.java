...
public class Main {
	public static void main(String[] args) {
		...
		// 2 funcionários com ensino superior (20%)
		funcionarios[8] = new FuncionarioGraduacao("Lucas", 9, "Escola Básica I", "Escola Médio E", "Universidade X");
		funcionarios[9] = new FuncionarioGraduacao("Mariana", 10, "Escola Básica J", "Escola Médio F",
				"Universidade Y");
		...
		// Imprimir detalhes de todos os funcionários
